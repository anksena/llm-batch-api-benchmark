...
1.  Lists up to 10k images from a GCS bucket
(llm-batch-api-benchmark-input-bucket/images).
  ...
  try:
    ...
    try:
      ...
      for blob in blobs:
        ...
        image_data.append(
            {"url": f"gs://{gcs_input_bucket_name}/{blob.name}", "mime": mime}
        )
