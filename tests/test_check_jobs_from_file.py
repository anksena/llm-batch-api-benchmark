...
class TestCheckJobsFromFile(unittest.TestCase):
    ...
    def test_latency_calculation(self):
        ...
        with open("test_output.jsonl", "r") as f:
            ...
            self.assertEqual(reports["job-123"].latency_seconds, 123.45)
            self.assertEqual(reports["job-456"].latency_seconds, 306.79)
            self.assertEqual(reports["job-789"].user_assigned_status, UserStatus.IN_PROGRESS)
